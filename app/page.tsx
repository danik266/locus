...
function Logo(){return <span className="logo"><svg className="logo-mark" viewBox="0 0 40 40" fill="none" aria-hidden="true"><path d="M28 9a14 14 0 1 0 0 22" stroke="currentColor" strokeWidth="5" strokeLinecap="round"/><path d="m23 26 5 5-5 5" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/></svg>Continue<span className="logo-dot">.</span></span>}
