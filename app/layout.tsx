...
export async function generateMetadata(): Promise<Metadata> {
 ...
 return { metadataBase:new URL(origin), title:pageTitles[locale], description:descriptions[locale], icons:{icon:'/favicon.ico'}, openGraph:{title:pageTitles[locale],description:descriptions[locale],locale:{en:'en_GB',ru:'ru_RU',kk:'kk_KZ'}[locale],type:'website',images:[{url:new URL('/og-continue.png',origin).href}]}, twitter:{card:'summary_large_image',title:pageTitles[locale],images:[new URL('/og-continue.png',origin).href]} };
}
